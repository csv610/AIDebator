...
class DebateConfig(BaseModel):
    ...
    supporter_persona: str | None = Field(None, description="Expert persona for the supporter")
    opposer_model: str = Field(..., min_length=1, description="LLM model for opposer")
    opposer_persona: str | None = Field(None, description="Expert persona for the opposer")
